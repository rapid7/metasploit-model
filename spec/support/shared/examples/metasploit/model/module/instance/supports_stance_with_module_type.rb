shared_examples_for 'Metasploit::Model::Module::Instance supports stance with module_type' do |context_module_type|
  context "with #{context_module_type.inspect}" do
    ...
    it 'should return true for supports?(:stance)' do
      module_instance.supports?(:stance).should be_true
    end
